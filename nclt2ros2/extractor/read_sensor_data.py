...
class ReadSensorData(BaseRawData):
    ...
    def read_gps_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            gps = np.loadtxt(
                self.sensor_data_dir + "/%s/gps.csv" % self.date, delimiter=","
            )
    ...
    def read_gps_rtk_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            gps_rtk = np.loadtxt(
                self.sensor_data_dir + "/%s/gps_rtk.csv" % self.date, delimiter=","
            )
    ...
    def read_gps_rtk_err_csv(self, all_in_one=None):
        ...
        """
        if self.sensor_data_flag:
            gps_rtk_err = np.loadtxt(
                self.sensor_data_dir + "/%s/gps_rtk_err.csv" % self.date, delimiter=","
            )
    ...
    def read_kvh_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            kvh = np.loadtxt(
                self.sensor_data_dir + "/%s/kvh.csv" % self.date, delimiter=","
            )
    ...
    def read_ms25_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            ms25 = np.loadtxt(
                self.sensor_data_dir + "/%s/ms25.csv" % self.date, delimiter=","
            )
    ...
    def read_odometry_cov_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            odom_cov = np.loadtxt(
                self.sensor_data_dir + "/%s/odometry_cov.csv" % self.date, delimiter=","
            )
    ...
    def read_odometry_cov_100hz_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            odom_cov = np.loadtxt(
                self.sensor_data_dir + "/%s/odometry_cov_100hz.csv" % self.date,
                delimiter=",",
            )
    ...
    def read_odometry_mu_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            odom = np.loadtxt(
                self.sensor_data_dir + "/%s/odometry_mu.csv" % self.date, delimiter=","
            )
    ...
    def read_odometry_mu_100hz_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            odom = np.loadtxt(
                self.sensor_data_dir + "/%s/odometry_mu_100hz.csv" % self.date,
                delimiter=",",
            )
    ...
    def read_wheels_csv(self, all_in_one=None):
        ...
        if self.sensor_data_flag:
            wheels = np.loadtxt(
                self.sensor_data_dir + "/%s/wheels.csv" % self.date, delimiter=","
            )
